...
public class DigitalSignatureCreator {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.printf("小王的私鑰（Base64）：%s%n", Base64.getEncoder().encodeToString(privateKey.getEncoded()));
		...
		System.out.printf("小王的私鑰（Hex）：%s%n", KeyUtil.bytesToHex(privateKey.getEncoded()));
		System.out.printf("小王的數位簽章：%s%n", KeyUtil.bytesToHex(digitalSignature));
